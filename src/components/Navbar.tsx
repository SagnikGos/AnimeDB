...
export default function Navbar() {
  ...
  const navLinks = [
    ...
    { name: "Explore", path: "/search", icon: <TrendingUp className="w-4 h-4" /> },
    { name: "Suggestion", path: "/suggest", icon: <BookmarkPlus className="w-4 h-4" /> },
  ];
    ...
    <>
      ...
      >
        <div className="container mx-auto px-4 flex items-center">
          ...
          {/* Center Navigation - with fixed width and centered text */}
